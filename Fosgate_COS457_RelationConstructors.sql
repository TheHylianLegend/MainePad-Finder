...
-- DATE OF GITHUB COMMIT: 10/28/2025
...
CREATE TABLE RENTER (
    ...
    REAL_NAME NVARCHAR(200) NOT NULL,
    BIRTH_DATE DATE NOT NULL,
    FOREIGN KEY (RENTER_ID, USERNAME, PASS_WORD, 
				EMAIL, PHONE_NUMBER, GENDER, 
                PROF_DESC, PICTURE_URL, REAL_NAME, BIRTH_DATE) 
    REFERENCES USER_PROF (USER_ID, USERNAME, PASS_WORD, 
				EMAIL, PHONE_NUMBER, GENDER, PROF_DESC,
                PICTURE_URL, REAL_NAME, BIRTH_DATE)
);
...
CREATE TABLE LANDLORD (
    ...
    REAL_NAME NVARCHAR(200) NOT NULL,
    BIRTH_DATE DATE NOT NULL,
    FOREIGN KEY (LANDLORD_ID, USERNAME, PASS_WORD, 
				EMAIL, PHONE_NUMBER, GENDER, 
                PROF_DESC, PICTURE_URL, REAL_NAME, BIRTH_DATE) 
    REFERENCES USER_PROF (USER_ID, USERNAME, PASS_WORD, 
				EMAIL, PHONE_NUMBER, GENDER, PROF_DESC,
