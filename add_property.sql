...
CREATE PROCEDURE ADD_PROPERTY (
    ...
    IN P_RENT_COST INT,
    IN P_PROPERTY_RATING FLOAT(1,2),
    IN P_BEDS SMALLINT,
...
BEGIN
	...
	INSERT INTO PROPERTY (
        RENT_COST, PROPERTY_RATING, LANDLORD_ID, BATHROOMS, BEDS, CAN_RENT, APT_NUM
    ) VALUES (
        P_RENT_COST, P_PROPERTY_RATING, P_LANDLORD_ID, P_BATHROOMS, P_BEDS, P_CAN_RENT, P_APT_NUM
    );
